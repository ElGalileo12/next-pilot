  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col">
            ...
            <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
              <div className="pt-20 sm:pt-0">
                ...
                <p className="mt-2 text-lg leading-relaxed text-gray-600">
                  Una herramienta para administrar equipos de fútbol,
                  optimizando la gestión de partidos, pagos y actualizaciones
                  del club.
                </p>
              </div>
              <div className="flex justify-start mt-6">
                <Link
                  href="/auth/signin"
                  className="flex items-center gap-5 self-start rounded-lg bg-sky-950 px-14 py-2.5 text-sm font-medium text-white transition-colors hover:bg-sky-600 md:text-base"
                >
        ...
        <section id="sobre-nosotros" className="mt-10 md:mt-10 pb-40 relative">
          <div
                    ...
                    <div className="relative flex flex-col">
                      <div className="px-4 py-5 flex-auto">
                        ...
                        <p className="mb-4 text-gray-300 text-sm">
                          Accede a una plataforma segura para gestionar tus
                          pagos de manera rápida y sin complicaciones.
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <section id="torneos" className="relative bg-sky-950">
          <p className="text-center text-white text-3xl font-bold pt-10">
            Breve descripción de los torneos
          </p>
        </section>

        <section id="precios" className="relative bg-sky-950">
          <p className="text-center text-white text-3xl font-bold pt-10">
            Pues aqui van unas card con precios
          </p>
        </section>
      </main>
      <footer className="relative bg-sky-950 pt-8 pb-6">
        <p className="text-white text-center p-4 text-xl font-bold">
          Esto es un footer
        </p>
      </footer>
    </>
